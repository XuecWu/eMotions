...
class SwinTransformerBlock3D(nn.Module):
    ...
    Args:
        ...
        use_checkpoint (bool, optional): Checkpoint API deployment. Default: False
    """

    def __init__(self, dim, num_heads, window_size=(2,7,7), shift_size=(0,0,0), mlp_ratio=4., qkv_bias=True, qk_scale=None,
...
class PatchMerging(nn.Module):
    ...
    def forward(self, x):
        ...
        Forward function.
        Args:
            x: Input feature, tensor shape (B, D, H, W, C).
        """
        B, D, H, W, C = x.shape
...
class BasicLayer(nn.Module):
    ...
    """
    def __init__(self, dim, depth, num_heads, window_size=(1,7,7), mlp_ratio=4., qkv_bias=False, qk_scale=None, drop=0., attn_drop=0.,
    ...
    def forward(self, x):
        ...
        Forward function.
        Args:
            x: Input feature, tensor size (B, C, D, H, W). Depth refers to time dimension
        """
...
class SwinTransformer3D(nn.Module):
    ...
    """
    def __init__(self, pretrained=None, pretrained2d=True, patch_size=(4,4,4), in_chans=3, embed_dim=96, depths=[2, 2, 6, 2], num_heads=[3, 6, 12, 24],
                 window_size=(8,7,7), mlp_ratio=4., qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0., drop_path_rate=0.2, norm_layer=nn.LayerNorm,
    ...
    def inflate_weights(self, logger: MMLogger) -> None:
        ...
        for k in relative_position_bias_table_keys:
            ...
            if nH1 != nH2:
                ...
                if L1 != L2:
                    S1 = int(L1 ** 0.5)
                    relative_position_bias_table_pretrained_resized = torch.nn.functional.interpolate(relative_position_bias_table_pretrained.permute(1, 0).view(1, nH1, S1, S1),
    ...
    def init_weights(self, pretrained=None):
        ...
        Args:
            pretrained (must be str, optional): the Path to pre-trained weights.
                Defaults to None.
        """
        def _init_weights(m):
        ...
        if isinstance(self.pretrained, str):
            ...
            logger = MMLogger(name='my_logger')
