...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Write n_frames files for extracted frame directories.")
    parser.add_argument("--frame_dir", required=True, help="Root directory of extracted video frames organized by class/video_id.")
    args = parser.parse_args()


    dir_path    = args.frame_dir

    class_name1  = "Excitation"
    class_process(dir_path, class_name1)
    class_name2  = "Fear"
    class_process(dir_path, class_name2)
    class_name3  = "Neutral"
    class_process(dir_path, class_name3)
    class_name4  = "Relaxation"
    class_process(dir_path, class_name4)
    class_name5  = "Sadness"
    class_process(dir_path, class_name5)
    class_name6  = "Tension"
    class_process(dir_path, class_name6)
